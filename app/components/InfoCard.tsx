...
const InfoCard: FC<InfoCardProps> = ({
  ...
  return (
    <div className="relative flex flex-col items-center text-center h-screen justify-center">
      ...
      <div className="absolute top-[180px] transform -translate-y-1/2 w-[400px] h-0.5 bg-gradient-to-r from-white via-orange-500 to-white"></div>
      <div className="absolute bottom-[180px] transform translate-y-1/2 w-[400px] h-0.5 bg-gradient-to-r from-white via-orange-500 to-white"></div>
